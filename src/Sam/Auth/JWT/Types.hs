...
import Crypto.JWT (HasClaimsSet, ClaimsSet, claimsSet, emptyClaimsSet)
...
data UserClaims = UserClaims { jwtClaims               :: ClaimsSet
...
instance FromJSON UserClaims where
  parseJSON = Aeson.withObject "UserClaims" $ \o -> UserClaims
...
emptyUserClaims = UserClaims { jwtClaims = emptyClaimsSet
                             , userClaimsEmail = ""
